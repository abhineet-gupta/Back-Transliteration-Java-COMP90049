...
# Name: Abhineet Gupta; SID: 719080
...
(Option 4 is enabled by default; thus those lines should be commented out before selecting another method)
	...
	1. GED (Levenshtein): 96-113
	2. Soundex processing: 117-134
	3. GED (mod-r, mod-i): 96-113, 238-247, 303-318 
	4. GED (mod i/r) + Soundex: 161-182 + ones for GED (mod-r, mod-i) above
	5. Soundex + GED (mod i/r): 117-134, 139-157, 238-247, 303-318
	
	PS: If GED of any sort is applied as the last method e.g. in SX + GED or GED by itself:
		Change variable name on line 196, 203 & 206
			from sxScoreNamesMap to scoreNamesMap, and vice versa if GED is not the last method applied.
